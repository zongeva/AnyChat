 ...
 * 群成员列表
 */
public class GroupMemberAdapterNormal extends BaseRecyclerAdapter<GroupMemberAdapterNormal.GroupMemberViewHolder> implements SectionIndexer {
    boolean selected;
    ...
    public GroupMemberAdapterNormal(Context context) {
...
/*        List<Member> list = SDKClient.instance().getMemberService().getList();
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new GroupMemberViewHolder(View.inflate(context, R.layout.vim_item_contact_has_index2, null));
    }
